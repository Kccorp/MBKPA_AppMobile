...
public class ListeCollector3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(ListeCollector3.this, id, Toast.LENGTH_SHORT).show();
            }
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(ListeCollector3.this, CollectorActivity.class));
    ...
    public List<Scooter> getDataSource(){
        RequestQueue queue = Volley.newRequestQueue(ListeCollector3.this);
        String url = "https://lotte-api.herokuapp.com/collector3";
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    ScooterAdapter adap = new ScooterAdapter(liste_des_trott, ListeCollector3.this);
                    lv.setAdapter(adap);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ListeCollector3.this, "Echec", Toast.LENGTH_SHORT).show();
            }
        });
